...
export function EmptyPaymentsState({
  ...
  return (
    ...
    >
      <div className="w-14 h-14 rounded-2xl bg-surface-hover border border-default flex items-center justify-center mb-4 shadow-sm">
        <Icon className="w-6 h-6 text-muted" />
      </div>
      <h3 className="font-heading font-semibold text-base text-primary mb-1.5">{title}</h3>
