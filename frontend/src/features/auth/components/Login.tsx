...
export function Login() {
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-canvas">
      ...
      <div className="flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-32">
        <div className="mx-auto w-full max-w-sm lg:max-w-md">
          ...
          <div className="flex items-center gap-2 mb-8">
            ...
            <span className="text-xl font-heading font-bold text-primary tracking-tight">KyberGym</span>
          </div>

          <h2 className="text-2xl sm:text-3xl font-heading font-bold tracking-tight text-primary">
            Sign in to your account
          </h2>
          <p className="mt-2 text-sm text-secondary mb-8">
      ...
      <div className="hidden lg:flex relative bg-surface-hover flex-col justify-center items-center overflow-hidden border-l border-subtle">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-success/20 rounded-full blur-[100px] pointer-events-none"></div>
        
        <div className="relative z-10 max-w-lg text-center px-8">
          <Dumbbell className="h-16 w-16 text-primary mx-auto mb-6" />
          <h1 className="text-4xl font-heading font-bold text-primary mb-4 tracking-tight">
